...
public class PSDWorldActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String psdVersion = SystemProperties.get("ro.psd.version");
        psdVersion = psdVersion.replaceAll("([0-9\\.]+?)-.*", "$1");
        tv.setText("Paranoid SaberDroid " + psdVersion);
